  ...
  return (
    <section>
      <div className="container pt-43 pb-25 max-w-xl mx-auto px-5">
        ...
        <p className="texts_14_regular text-second mb-6">
        ...
        <form onSubmit={submit} className="flex flex-col gap-5">
          ...
          />
          <button disabled={loading} className="bg-head text-white py-4">
            {loading ? "SENDING..." : "SEND RESET LINK"}
          </button>
        </form>
        <Link href="/login-register" className="block mt-6 underline text-sm">
          Back to login
        </Link>
      </div>
    </section>
