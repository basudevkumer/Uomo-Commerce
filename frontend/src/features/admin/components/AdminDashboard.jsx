...
const revenue = [
  ...
  { month: "Jun", value: 36700 },
  { month: "Jul", value: 32100 },
  { month: "Aug", value: 39800 },
  { month: "Sep", value: 34500 },
  { month: "Oct", value: 41200 },
  { month: "Nov", value: 37600 },
  { month: "Dec", value: 48294 },
];
      ...
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <XAxis
            ...
            tickLine={false}
            axisLine={false}
            tick={{ fontSize: 10, fill: "var(--color-second)" }}
          />
          <YAxis
            tickLine={false}
            axisLine={false}
          ...
          <Tooltip
            ...
            cursor={{ stroke: "var(--color-footer)" }}
          />
          <Area
            type="monotone"
            dataKey="value"
    ...
    <div>
      <AdminPageIntro
        ...
        action={
          <Link
            href="/admin/products"
            className="inline-flex items-center gap-2 rounded-xl bg-head px-4 py-2.5 text-[11px] font-semibold text-white hover:bg-black"
          >
          ...
          <AdminCard key={t} className="p-5">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="mt-2 text-[27px] font-bold tracking-[-.04em]">
                  {v}
                </p>
              </div>
            ...
            <p className="mt-4 flex items-center gap-1 text-[11px] font-semibold text-[#16834b]">
              <TrendingUp size={13} />
              {c}
              <span className="font-normal text-second">vs last month</span>
            </p>
          </AdminCard>
        ))}
      </div>
      ...
      <div className="mt-5 grid gap-5 xl:grid-cols-[minmax(0,1.6fr)_350px]">
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="mt-1 text-[12px] text-second">
                Revenue performance across the last 12 months
              </p>
            </div>
            <button className="rounded-xl border border-footer px-3 py-2 text-[10px] font-semibold">
              Last 12 months
            </button>
          </div>
          <SalesChart />
        ...
        <AdminCard className="p-6">
          ...
          <div className="mt-6 space-y-5">
            {top.map(([name, sold, revenue], i) => (
              <div key={name} className="flex items-center gap-3">
                <span className="flex size-9 shrink-0 items-center justify-center rounded-xl bg-secondbg text-[10px] font-bold">
                  0{i + 1}
                </span>
          ...
          <Link
            href="/admin/products"
            className="mt-7 inline-flex items-center gap-1 text-[10px] font-semibold text-red"
          >
      ...
      <AdminCard className="mt-5 overflow-hidden">
        <div className="flex items-center justify-between border-b border-footer px-5 py-5 sm:px-6">
          <div>
            ...
            <p className="mt-1 text-[12px] text-second">
              Keep track of your latest orders
            </p>
          </div>
          <Link
            href="/admin/orders"
